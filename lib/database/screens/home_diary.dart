...
import 'package:flutterapp/database/components/faderoute.dart';
import 'package:flutterapp/database/data/models.dart';
import 'package:flutterapp/database/screens/edit.dart';
import 'package:flutterapp/database/screens/view.dart';
import 'package:flutterapp/database/services/database.dart';
// import 'settings.dart';
import 'package:outline_material_icons/outline_material_icons.dart';
import '../components/cards.dart';

// ignore: camel_case_types
class MyHomePage_Diary extends StatefulWidget {
...
class _MyHomePageState extends State<MyHomePage_Diary> {
  bool isFlagOn = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: Text('เพิ่มไดอารี่'.toUpperCase()),
        icon: Icon(Icons.add),
      ),
  ...
  Widget buildImportantIndicatorText() {
    return AnimatedCrossFade(
      ...
      firstChild: Padding(
        ...
        child: Text(
          'จะแสดงเฉพาะไดอารี่ที่ปักหมุดไว้'.toUpperCase(),
          style: TextStyle(
              fontSize: 15, color: kPrimaryColor, fontWeight: FontWeight.w500),
        ),
      ),
