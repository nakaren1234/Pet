...
class _NewsPageState extends State<NewsPage> {
  ...
  _getData() async {
    try {
      ...
      var url =
          'https://newsapi.org/v2/top-headlines?country=th&apiKey=296eca6a0a164733879a0e47a604c918&page=$page&pagesize=$pageSize';
